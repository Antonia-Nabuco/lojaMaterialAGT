...
int main(){
    char opcion;  
    printf("\nOla seja bem vindo ! \nO sistema CONSTRUCOM eh uma aplicacao de orcamento e compra de materiais de construcao");
    printf("\nDigite : \na) Ver Horarios \nb) Fazer orcamento de materiais\n");
    scanf(" %c",&opcion);
    if(opcion=='A' || opcion=='a'){
        printf("Segue os horarios: Segunda a Sexta, das 8h as 18h\n");
    }
        ...
        printf("Desculpa, esta opcao nao existe\n");
    }
    return 0;
}
